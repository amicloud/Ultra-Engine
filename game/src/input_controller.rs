...
// use ultramayor_engine::{MouseButton};
...
//             Keycode::V => self.view_toggle = state,
//             Keycode::Up => self.arrow_up = state,
//             Keycode::Down => self.arrow_down = state,
//             Keycode::Left => self.arrow_left = state,
//             Keycode::Right => self.arrow_right = state,
//             _ => {}
//         }
//     }
// }
